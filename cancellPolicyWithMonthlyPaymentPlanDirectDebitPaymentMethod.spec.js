...
describe('Cancell a policy', () => {
  ...
  it('Should create policy', async function () {
    createPolicyResponse = await createPolicy(riskData, 11, 'Direct Debit', false)
  })

  it('Should cancell policy with installments and payment method Direct Debit', async function () {
    ...
    const insurerValue = parseFloat(calculateResponse.insurerValue)
    ...
    // expect(insurerValue).toEqual(grossPremiumRetrieveQuote)
