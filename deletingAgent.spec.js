...
describe("Deleting agent test", function () {
  beforeEach(() => {
    cy.server();
  ...
  it.only("deleting agent", function () {
    ...
    //cy.get("#agents-table-delete-1").click();
    navigation.getPopupTitle().should('have.text',"Are you sure you want to delete this Agent?");
    navigation
    .getPopupParagraph().should('have.text',"WARNING: If you click yes, this Agent's details will be lost.");
