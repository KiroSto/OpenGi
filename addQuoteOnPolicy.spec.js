...
describe('AddQuote test on policy', () => {
  ...
  it('Should Add New Quote', async function () {
    ...
    const getRiskRespBeforeAddNewQuote = await getRisk(createPolicyResponse.policyDetailsId, createPolicyResponse.policyDetailsHistoryId, createPolicyResponse.productTypeId)
