...
describe("Successfully deactivating business line test", function () {
  let socketServer;
  const baseUrl = "https://localhost:3000/";
  const navigation = new Navigation();
    beforeEach(() => {
    ...
    it.only("deactivating business line by deleting all of the previous dependencies", function () {
